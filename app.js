...
var ECT, MongoStore, allowCrossDomain, app, auth, client, config, device, ectRenderer, eventbrite, express, fs, github, login, mongo, news, notification, oauth2, passport, path, requestLogger, routes, security, site, twitter, user, util, utils, wordpress,
  _this = this;
