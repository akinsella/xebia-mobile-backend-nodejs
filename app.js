...
var ECT, MongoStore, allowCrossDomain, app, auth, client, config, device, ectRenderer, eventbrite, express, fs, github, login, mongo, news, notification, oauth2, passport, path, requestLogger, route, security, site, twitter, user, util, utils, vimeo, wordpress,
  _this = this;
