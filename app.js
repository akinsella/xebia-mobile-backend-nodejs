...
var ECT, MongoStore, allowCrossDomain, app, auth, authMiddleware, authService, card, client, config, device, ectRenderer, eventbrite, express, fs, github, gracefullyClosing, httpServer, login, mongo, news, notification, oauth2, passport, path, requestLogger, role, route, twitter, user, util, utils, vimeo, wordpress;
