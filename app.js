...
var MongoStore, allowCrossDomain, app, auth, authMiddleware, authService, card, client, config, device, eventbrite, express, fs, github, gracefullyClosing, httpServer, mongo, news, notification, oauth2, os, passport, path, requestLogger, role, security, twitter, user, util, utils, vimeo, wordpress;
