...
var MongoStore, allowCrossDomain, app, auth, authMiddleware, authService, card, client, config, connectDomain, device, eventbrite, express, fs, github, gracefullyClosing, httpServer, mongo, news, notification, oauth2, passport, path, requestLogger, role, security, twitter, user, util, utils, vimeo, wordpress;
