...
var MongoStore, allowCrossDomain, app, auth, authMiddleware, authService, client, config, express, fs, gracefullyClosing, httpServer, mongo, newrelic, oauth2, passport, path, requestLogger, role, security, user, util, utils;
