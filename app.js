...
var ECT, MongoStore, allowCrossDomain, app, auth, cacheMiddleware, client, config, device, ectRenderer, eventbrite, express, fs, github, gracefullyClosing, httpServer, login, mongo, news, notification, oauth2, passport, path, requestLogger, route, security, site, twitter, user, util, utils, vimeo, wordpress;
