...
var authorPosts, authors, categories, categoryPosts, datePosts, dates, post, processRequest, recentPosts, redis, tagPosts, tags, utils, _;
...
tagPosts = function(req, res) {
  ...
  return processRequest(req, res, "http://blog.xebia.fr/wp-json-api/get_category_posts?id=" + tagId);
};
