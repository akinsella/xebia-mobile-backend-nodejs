...
var buildOptions, fetchDataFromUrl, getCacheKey, getContentType, getData, getIfUseCache, getParameterByName, getRandomInt, getUrlToFetch, isContentTypeJsonOrScript, processRequest, redis, removeParameters, request, responseData, sendJsonResponse, uid, useCache;
...
getData = function(options) {
  ...
  try {
    if (!useCache(options)) {
      ...
      return redis.client.get(options.cacheKey, function(err, data) {
        if (!err && data) {
