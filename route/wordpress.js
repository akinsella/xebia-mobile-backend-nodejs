...
filterEmptyChildren = function(children) {
  children = _(children).filter(function(child) {
    return child.type === "#text" && child.text.trim().length > 0 || child.children;
  });
...
areChildrenTextOnly = function(children) {
  ...
  for (_i = 0, _len = children.length; _i < _len; _i++) {
    child = children[_i];
    if (((_ref = child.type) === "VIDEO" || _ref === "IMG" || _ref === "CODE" || _ref === "TABLE" || _ref === "DIV") || !areChildrenTextOnly(child.children)) {
      return false;
    }
  }
  return true;
...
mergeSiblingTexts = function(children) {
  ...
  for (_i = 0, _len = children.length; _i < _len; _i++) {
    child = children[_i];
    index++;
    if (!child.children && ((_ref = child.type) === "#text" || _ref === "P" || _ref === "SPAN" || _ref === "EM" || _ref === "A" || _ref === "UL" || _ref === "OL" || _ref === "LI" || _ref === "STRONG" || _ref === "EM")) {
