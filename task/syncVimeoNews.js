...
var Cache, News, OAuth, apiHost, async, config, db, moment, oauth, processVideos, request, synchronize, synchronizeVideoNews, utils, _;
  ...
  return News.findOne({
    ...
    if (err) {
      ...
      return newsEntry.save(function(err) {
        return callback(err, news.typeId);
      });
    } else {
      return callback(err, news.typeId);
    }
...
/*
//@ sourceMappingURL=syncVimeoNews.map
*/
